...
{#if isOpen}
	<dialog bind:this={dialogEl} class="bg-transparent p-0" on:close={() => (isOpen = false)}>
		<div
			role="presentation"
				...
				<div class="p-6">
					...
					<form on:submit|preventDefault={handleSubmit} class="space-y-4">
						...
						>
							...
							/>
							<span>
								<Fa icon={faCloudArrowUp} class="mx-auto h-12 w-12 text-sucu-gray" />
								<p class="mt-1 text-sm text-sucu-gray-dark">
