			...
			<div class="bg-white w-full max-w-3xl rounded-md shadow-lg max-h-[85vh] flex flex-col">
				...
				<div class="p-6 overflow-y-auto flex-1">
					<form on:submit|preventDefault={handleSubmit} class="space-y-6">
						<!-- Title -->
						<div class="space-y-1">
							<span class="text-sm text-sucu-dark-gray font-semibold"
								>{variant === 'announcement' ? 'ชื่อประกาศ' : 'ชื่อสถิติ'}</span
							>
							<input
								type="text"
								bind:value={title}
						...
						<div class="grid grid-cols-2 gap-4">
							<div>
								<span class="text-xl text-sucu-dark-gray font-semibold"
									>{variant === 'announcement'
										? 'เพิ่มรูปภาพของหน้าประกาศ'
										: 'เพิ่มรูปปกหน้าสถิติและงบประมาณ'}</span
								>
								<input
									type="file"
						...
						<div class="bg-sucu-pink-04 p-4">
							<div class="space-y-2 flex flex-col">
								<span class="text-md text-sucu-dark-gray font-semibold"
									>เลือกรูปที่จะถูกตั้งเป็นรูปแรก</span
								>
								<span class="text-sm text-sucu-gray"
									>ลำดับของรูปภาพจะถูกเรียงตามเวลาที่อัปโหลด
									สามารถเลือกรูปภาพตามลำดับที่เพื่อตั้งให้อยู่เป็นอันดับแรก</span
								>
								<select
						...
						<div class="grid grid-cols-2 gap-4">
							<div>
								<span class="text-sm text-sucu-dark-gray font-semibold text-xl"
									>{variant === 'announcement'
										? 'เพิ่มเอกสารในหน้าประกาศ'
										: 'เพิ่มเอกสารในหน้าสถิติและงบประมาณ'}</span
								>
								<input
									type="file"
